...
- Fully reproduces original resnet paper results
- Simple experiment management, folder with all artifacts and logging
- Report timings
- Half precision support
- Mostly just single script code

## Non-Features

To keep code minimal, below are NOT implemented and I have no plans to add these features.

- No tensorboard logging
- No distributed or multi-gpu
...
* darts is better than resnet optimizer (89.9 vs 88.3), with scheduler darts pushes 90.3
...
* resnet18 with resnet setting ups accuracy by 1.6% i.e. 90.3% compared to resnet34, epoch @ 6.6s
* resnet18 with darts setting + consine sched pushes 89.7, epoch @ 6.6s
...
* Implement AdamW + Superconvergence - 94% in 30 epochs or with test time aug, 18 epochs
